    ...
    $.flagStrap = function (element, options, i) {
        ...
        var buildDropDownButton = function () {
            ...
            var buttonLabel = $('<span/>')
                .addClass('flagstrap-selected-' + uniqueId + ' jgjflagcountry')
                .html($selectedLabel)
                .append(selectedText);
            ...
            var button = $('<button/>')
                ...
                .addClass('jgjcountrycls ' + plugin.settings.buttonType + ' ' + plugin.settings.buttonSize + ' dropdown-toggle' + ' ' +'btn ' )
                .html(buttonLabel);

            $('<span/>')
                .addClass('caret' + ' jgjcaret')
