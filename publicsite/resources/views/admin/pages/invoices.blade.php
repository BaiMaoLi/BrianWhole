                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Projects <span class="table-project-n">Data</span> Table <?php if(isset($offer)) var_dump($offer); ?> </h1>
                            </div>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    @for($i=0;$i<count($data);$i++)
                                        ...
                                        <tr> 
                                            ...
                                            <a classs="btn btn-primary" style = "cursor: pointer;
                                                    ...
                                                    font-size: 12px;
                                                    padding: 4px 12px;
                                                    border-radius: 3px;" data-toggle="modal" data-target="#cModal" onclick="select_accept_offer({{$data[$i]->_id}},{{$data[$i]->id}},{{$data[$i]->amount}})">Accept</a>
                                            ...
                                            <a classs="btn btn-danger" style = "cursor: pointer;
                                                    ...
                                                    border-radius: 3px; float:right;"
                                                     data-toggle="modal" data-target="#rModal" onclick="select_refuse_offer({{$data[$i]->_id}},{{$data[$i]->id}},{{$data[$i]->amount}})">Refuse</a>
                                                    </div>
                                                    </td>
                                        </tr>
                                            @endif
                                ...
                                <div class="modal fade" id="cModal" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="accept_offer()">Accept</button>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                <div class="modal fade" id="rModal" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                        <button type="button" class="btn btn-warning" onclick="accept_offer()">Refuse</button>
                                        </div>
                                    </div>
                                    </div>
                                </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function select_accept_offer(_id, user_id, amount){
            ...
            $('#offer_type').val('accept');
        }
        
        function select_refuse_offer(_id){
            $('#offer_id').val(_id);
            $('#offer_type').val('refuse');
        }
