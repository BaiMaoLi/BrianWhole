    ...
    <div class = "container menu-content" style="width : 100%;">
        ...
        <form>
            ...
            <div class="input-group" style = "border-radius:50%;">
                ...
                <input id="withd_balance" disabled type="number" class="form-control" name="withd_balance" placeholder="Balance" value="<?php echo $balance; ?>" style="text-align : right; font-size : 20px; background : white;">
            </div>
            <br>
    	...
    	<script>
    		$(function() {
                ...
                function onWithDrawlCancel(){
                    window.location.replace("https://remittyllc.com/withdrawal");
                }
                function onWithDrawlSubmit(){
                    ...
                    if(!validateEmail(info)){
                        alert('Sorry! please insert your avaiable email in info');
                        $('#withd_info').addClass('input_warning');
                        return;
                    }
                    ...
                    if(balance>0 && amount>0 && amount<=balance){
                        $('#withd_amount').removeClass('input_warning');
                        $('#withd_info').removeClass('input_warning');
                        $.ajax({
                            headers: {
                        ...
                        $('#withd_amount').addClass('input_warning');
                    }
                }
