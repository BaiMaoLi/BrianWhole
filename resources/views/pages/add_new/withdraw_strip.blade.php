...
<div class="container tab_container" style="background: white; width: 85%;">
  <h3>Request Withdraw to Admin via strip</h3>
  ...
  <div class="tab-content">
    ...
    <div class = "container menu-content" style="width : 100%;">
        ...
        <form>
            ...
            <button type="button" class="btn btn-warning" style="border-radius:3px; width : 200px;"  onclick="onWithDrawlSubmit();">Submit</button>
            </div>
        </form>
        <br>
